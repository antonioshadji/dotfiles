...
**Input limit**: The `--input` text field has a maximum of 20,000 characters. Exceeding this causes a `ValidationException`. For longer queries, truncate or summarize before sending.
